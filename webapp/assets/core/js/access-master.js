...
master.refreshGridUser = function () {
    ...
    viewModel.ajaxPostCallback('/access/getuser', {}, function (data) {
...
master.saveUser = function () {
    ...
    viewModel.ajaxPostCallback('/access/saveuser', payload, function (data) {
        swal({
            title: 'Success',
            text: 'Changes saved',
            type: 'success',
...
master.deleteUser = function (_id) {
    swal({
        ...
        viewModel.ajaxPostCallback('/access/deleteuser', payload, function (data) {
            swal({
                title: 'Success',
...
master.refreshGridGroup = function () {
    ...
    viewModel.ajaxPostCallback('/access/getgroup', {}, function (data) {
...
master.saveGroup = function () {
    ...
    viewModel.ajaxPostCallback('/access/savegroup', payload, function (data) {
        swal({
            title: 'Success',
            text: 'Changes saved',
            type: 'success',
...
master.deleteGroup = function (_id) {
    swal({
        ...
        viewModel.ajaxPostCallback('/access/deletegroup', payload, function (data) {
            swal({
                title: 'Success',
                text: 'Menu successfully deleted',
                type: 'success',
...
master.refreshGridMenu = function () {
    ...
    viewModel.ajaxPostCallback('/access/getaccessmenu', {}, function (data) {
        if (data.length == 0) {
            return
        }
...
master.saveAccessMenu = function () {
    ...
    payload.Index = parseInt(payload.Index, 10)

    viewModel.ajaxPostCallback('/access/saveaccessmenu', payload, function (data) {
        swal({
            title: 'Success',
            text: 'Changes saved',
            type: 'success',
...
master.deleteAccessMenu = function () {
    swal({
        ...
        viewModel.ajaxPostCallback('/access/deleteaccessmenu', payload, function (data) {
            swal({
                title: 'Success',
                text: 'Menu successfully deleted',
                type: 'success',
...
master.refreshGridLog = function () {
    viewModel.ajaxPostCallback('/access/getsession', {}, function (data) {
        var config = {
            dataSource: {
                data: data,
                schema: {
