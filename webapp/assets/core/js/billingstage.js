...
bs.getSalesVsCollectionData = function () {
    return new Promise(function (resolve, reject) {
        var doGetOctober = function (callbackOK) {
            ...
            param1.RequiredDeliveryDateStart = bs.getDataValue(moment('2017-10-01').toDate())
            param1.RequiredDeliveryDateFinish = bs.getDataValue(moment('2017-10-31').toDate())
        ...
        var doGetSeptember = function (callbackOK) {
            ...
            param2.RequiredDeliveryDateStart = bs.getDataValue(moment('2017-09-01').toDate())
            param2.RequiredDeliveryDateFinish = bs.getDataValue(moment('2017-09-30').toDate())
        ...
        var doGetAugust = function (callbackOK) {
            ...
            param3.RequiredDeliveryDateStart = bs.getDataValue(moment('2017-07-26').toDate())
            param3.RequiredDeliveryDateFinish = bs.getDataValue(moment('2017-08-31').toDate())
            param3.SalesOrderDateStart = bs.getDataValue(moment('2017-07-30').toDate())
            param3.SalesOrderDateFinish = bs.getDataValue(moment('2017-08-31').toDate())
...
bs.renderChartSalesVsCollection = function (data) {
    ...
    $('.chart-sales-vs-collection').replaceWith('<div class="chart-sales-vs-collection"></div>')
    $('.chart-sales-vs-collection').kendoChart(config)
}
...
bs.refreshGrid = function () {
    ...
    .then(function () {
        return bs.getSalesVsCollectionData()
    })
    .then(function (data) {
        bs.renderChartSalesVsCollection(data)
    })
